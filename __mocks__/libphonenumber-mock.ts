...
export default {
  ...
  countries: {
    ...
    'AO': [
      ...
      0,
      0,
      [['2\\d(?:[0134][25-9]|[25-9]\\d)\\d{5}'], ['9[1-49]\\d{7}']],
    ],
    'AR': [
      '54',
      '00',
    ...
    'AU': [
      ...
      [
        ...
        [
          '483[0-3]\\d{5}|4(?:[0-3]\\d|4[047-9]|5[0-25-9]|6[06-9]|7[02-9]|8[0-2457-9]|9[017-9])\\d{6}',
          [9],
        ],
    ...
    'BE': [
      ...
      [
        ...
        0,
        0,
        ['78(?:0[57]|1[0458]|2[25]|3[5-8]|48|[56]0|7[078])\\d{4}', [8]],
        0,
        0,
        ['7879\\d{4}', [8]],
      ],
    ...
    'BI': [
      ...
      0,
      0,
      [['22\\d{6}'], ['(?:29|31|6[189]|7[125-9])\\d{6}']],
    ],
    'BJ': [
      '229',
      '00',
    ...
    'BW': [
      ...
      [
        ...
        ['77200\\d{3}|7(?:[1-6]\\d|7[014-8])\\d{5}', [8]],
        0,
        ['90\\d{5}', [7]],
        0,
        0,
    ...
    'CD': [
      ...
      0,
      0,
      [['12\\d{7}|[1-6]\\d{6}'], ['88\\d{5}|(?:8[0-2459]|9[017-9])\\d{7}']],
    ],
    'CF': [
      '236',
      '00',
      ...
      0,
      0,
      [['2[12]\\d{6}'], ['7[0257]\\d{6}'], 0, ['8776\\d{4}']],
    ],
    'CG': [
      '242',
      '00',
    ...
    'CL': [
      ...
      [
        [
          '(?:2(?:1962|3(?:2\\d\\d|300))|80[1-9]\\d\\d)\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2-9])\\d{7}',
          [9],
        ],
        ['', [9]],
        ['(?:123|8)00\\d{6}', [9, 11]],
    ...
    'EC': [
      ...
      [
        ['[2-7][2-7]\\d{6}', [8]],
        ['964[0-2]\\d{5}|9(?:39|[57][89]|6[0-37-9]|[89]\\d)\\d{6}', [9]],
        ['1800\\d{6,7}', [10, 11]],
        0,
        0,
        0,
    ...
    'IL': [
      ...
      [
        ...
        [
          '5(?:(?:[0-489][2-9]|6\\d)\\d|5(?:01|2[2-6]|3[23]|4[45]|5[05689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}',
          [9],
        ],
        ...
        0,
        [
          '78(?:33|55|77|81)\\d{5}|7(?:18|2[23]|3[237]|47|6[58]|7\\d|82|9[235-9])\\d{6}',
          [9],
        ],
        ['1700\\d{6}', [10]],
      ],
    ...
    'IR': [
      ...
      [
        ...
        [
          '9(?:(?:0(?:[1-35]\\d|44)|(?:[13]\\d|2[0-2])\\d)\\d|9(?:(?:[0-2]\\d|44)\\d|5[15]0|8(?:1[0-2]|88)|9(?:0[013]|1[0134]|21|77|9[6-9])))\\d{5}',
          [10],
        ],
        0,
        0,
    ...
    'KI': [
      ...
      [
        ...
        ['73140\\d{3}|(?:630[01]|730[0-5])\\d{4}|[67]200[01]\\d{3}', [8]],
        0,
        0,
        0,
        0,
    ...
    'KR': [
      ...
      [
        ...
        ['10[01]\\d{6}|1(?:0[2-9]|[126-9]\\d)\\d{6,7}', [9, 10]],
        [
    ...
    'KW': [
      ...
      [
        ...
        [
          '(?:52(?:22|5[25])|6(?:222|70[013-9]|93[039])|9(?:11[01]|333|702))\\d{4}|(?:5(?:[05]\\d|1[0-7]|6[56])|6(?:0[034679]|5[015-9]|6\\d|7[67]|9[069])|9(?:0[09]|22|4[01479]|55|6[0679]|7[1-9]|8[057-9]|9\\d))\\d{5}',
          [8],
        ],
        ['18\\d{5}', [7]],
      ],
    ...
    'LR': [
      ...
      [
        ['(?:2\\d{3}|33333)\\d{4}', [8, 9]],
        ['(?:(?:330|555|(?:77|88)\\d)\\d|4[67])\\d{5}|5\\d{6}', [7, 9]],
        0,
        ['332(?:02|[34]\\d)\\d{4}', [9]],
      ],
    ],
    ...
    'LY': [
      ...
      0,
      0,
      [['(?:2[13-5]|5[1347]|6[1-479]|71)\\d{7}'], ['9[1-6]\\d{7}']],
    ],
    'MA': [
      '212',
      '00',
    ...
    'MK': [
      ...
      [
        ...
        ['7(?:(?:[0-25-8]\\d|3[2-4]|9[23])\\d|4(?:21|60))\\d{4}'],
        ['800\\d{5}'],
        ['5[02-9]\\d{6}'],
        0,
        0,
    ...
    'MN': [
      ...
      [
        ...
        ['(?:8(?:[05689]\\d|3[01])|9(?:[014-9]\\d|20|3[0-4]))\\d{5}', [8]],
        0,
        0,
        0,
        0,
    ...
    'NF': [
      ...
      0,
      0,
      [['(?:1(?:06|17|28|39)|3[0-2]\\d)\\d{3}'], ['3[58]\\d{4}']],
    ],
    'NG': [
      '234',
      '009',
    ...
    'PF': [
      ...
      0,
      0,
      [['4(?:[09][4-689]\\d|4)\\d{4}'], ['8[7-9]\\d{6}', [8]]],
    ],
    'PG': [
      '675',
      '00|140[1-3]',
    ...
    'SD': [
      ...
      0,
      0,
      [['1(?:5[3-7]|8[35-7])\\d{6}'], ['(?:1[0-2]|9[0-3569])\\d{7}']],
    ],
    'SE': [
      '46',
      '00',
    ...
    'SL': [
      ...
      0,
      0,
      [['22\\d{6}'], ['(?:25|3[0134]|7[5-9]|8[08]|99)\\d{6}']],
    ],
    'SM': [
      '378',
      '00',
    ...
    'TD': [
      ...
      0,
      0,
      [['22(?:[37-9]0|5[0-5]|6[89])\\d{4}'], ['(?:6[023568]|77|9\\d)\\d{6}']],
      '00',
    ],
    'TG': [
      '228',
    ...
    'TO': [
      ...
      [
        ...
        ['(?:6(?:3[02]|85|90)|7(?:[2-46]0|[578]\\d)|8[46-9]\\d)\\d{4}', [7]],
        ['0800\\d{3}', [7]],
        ['55[04]\\d{4}', [7]],
      ],
    ],
    ...
    'TT': [
      ...
      [
        [
          '868(?:2(?:01|1[89]|[23]\\d|4[0-2])|6(?:0[7-9]|1[02-8]|2[1-9]|[3-69]\\d|7[0-79])|82[124])\\d{4}',
        ],
        [
    ...
    'TW': [
      ...
      [
        [
          '24\\d{6,7}|(?:6412|8(?:2(?:3\\d|66)|36[24-9]))\\d{4}|(?:2[235-8]\\d|3[2-9]|4(?:[239]\\d|[78])|5[2-8]|6[235-79]|7[1-9]|8[7-9])\\d{6}',
          [8, 9],
        ],
        ['9[0-8]\\d{7}', [9]],
        ['80[0-79]\\d{6}', [9]],
    ...
    'UG': [
      ...
      [
        [
          '(?:20(?:(?:(?:[0147]\\d|5[0-4])\\d|2(?:40|[5-9]\\d)|3(?:0[67]|2[0-4])|810)\\d|6(?:00[0-2]|[15-9]\\d\\d|30[0-4]))|[34]\\d{5})\\d{3}',
        ],
        ['7260\\d{5}|7(?:[0157-9]\\d|20|4[0-4])\\d{6}'],
        ['800[1-3]\\d{5}'],
        ['90[1-3]\\d{6}'],
      ],
    ],
    ...
    'VI': [
      ...
      [
        [
          '340(?:2(?:0[12]|2[06-8]|4[49]|77)|3(?:32|44)|4(?:22|7[34]|89)|5(?:1[34]|55)|6(?:2[56]|4[23]|77|9[023])|7(?:1[2-57-9]|27|7\\d)|884|998)\\d{4}',
        ],
        [''],
        ['8(?:00|33|44|55|66|77|88)[2-9]\\d{6}'],
        ['900[2-9]\\d{6}'],
    ...
    'VN': [
      ...
      [
        ...
        [
          '(?:52[238]|8(?:79|9[689])|99[013-9])\\d{6}|(?:3\\d|5[689]|7[06-9]|8[1-68]|9[0-8])\\d{7}',
          [9],
        ],
        ['1(?:228\\d{4}|800\\d{4,6})', [8, 9, 10]],
        ['1900\\d{4,6}', [8, 9, 10]],
        0,
        0,
    ...
    'VU': [
      ...
      [
        ...
        ['57[2-5]\\d{4}|(?:5[0-689]|7[013-7])\\d{5}', [7]],
        0,
        0,
        0,
        0,
    ...
    'WF': [
      ...
      0,
      0,
      [['(?:50|68|72)\\d{4}'], ['(?:50|68|72|8[23])\\d{4}']],
    ],
    'WS': [
      '685',
      '0',
    ...
    'ZM': [
      ...
      0,
      0,
      [['21[1-8]\\d{6}'], ['(?:76|9[5-8])\\d{7}'], ['800\\d{6}']],
    ],
    'ZW': [
      '263',
      '00',
